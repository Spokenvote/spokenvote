...
ImroveCtrl = [ '$scope', '$location', '$rootScope', '$modalInstance', 'Proposal',
  ($scope, $location, $rootScope, $modalInstance, Proposal) ->
    $scope.alertService.clearAlerts()
...
EditProposalCtrl = [ '$scope', '$location', '$rootScope', '$modalInstance', 'Proposal',
  ($scope, $location, $rootScope, $modalInstance, Proposal) ->
...
DeleteProposalCtrl = [ '$scope', '$location', '$rootScope', '$modalInstance', 'Proposal',
  ($scope, $location, $rootScope, $modalInstance, Proposal) ->
    $scope.clicked_proposal = $scope.clicked_proposal
...
NewProposalCtrl = [ '$scope', '$modalInstance',
  ($scope, $modalInstance ) ->
